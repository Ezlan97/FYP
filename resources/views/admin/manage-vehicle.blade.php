						...
						<table class="table table-bordered" style="padding-top: 30px;">
							...
							<tbody id="tbody">
								...
								<tr>
									...
									<td>
										<a href="" class="btn blue btn-sm editBtn" data-toggle="modal" data-target="#editModal" data-vehicle_id="{{ $vehicle->id }}" data-vehicle_title="{{ $vehicle->title }}" data-vehicle_type="{{ $vehicle->type }}" data-vehicle_plate="{{ $vehicle->plate }}"><button class="btn btn-sm btn-info deleteBtn">Edit</button></a>
									</td>
								</tr>
								<?php $count++ ?>
								@endforeach
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-8">
							<input type="text" name="title" class="form-control input-line" id="m_vehicle_model">
						</div>
					</div>
					<div class="form-group col-md-12">
				...
				<div class="modal-body">
					<div class="table-scrollable table-scrollable-borderless">
						...
						<div class="form-group col-md-12">
							<label for="inputPassword1" class="col-md-4 control-label">Model</label>
							<div class="col-md-8">
								<input type="text" name="title" class="form-control input-line" id="vmodel" value="{{ old('title') }}">
							</div>
						</div>
						<div class="form-group col-md-12">
							<label for="inputPassword1" class="col-md-4 control-label">Plate</label>
		...
		<script>
			$(document).ready(function(){
				...
				$('.editBtn').click(function(){
					...
					$("#m_vehicle_model").val($(this).data('vehicle_title'));
